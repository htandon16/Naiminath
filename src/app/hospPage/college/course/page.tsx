...
import { faEnvelope, faFileWord, faPhone } from "@fortawesome/free-solid-svg-icons";
  ...
  return (
    <div className=" flex flex-col justify-center items-center">
      ...
      <div className="w-[55vw] bg-white p-6 rounded-md shadow-md ring-1 ring-slate-100 font-serif text-[#7f7f7f] my-12">
        ...
        <p className="mb-4">
          BAMS course provides the complete knowledge about ‘Ashtanga Ayurveda’
          along with scientific advances in modern medicine along with extensive
          practical training. Central Council of Indian Medicine (CCIM) is the
          regulatory body for admission to Ayurveda education at undergraduate
          as well as postgraduate level and for practice Ayurvedic medicine in
          India.
        </p>
        ...
        <ul className="list-disc ml-6 mb-4">
          ...
          <li>
            For foreign students, any other equivalent qualification approved by
            the University will be allowed.
          </li>
        </ul>
        <Link href='/images/fee_st_namc.pdf'>
        <div
       ...
       >
        ...
        <h2 className="text-2xl font-medium text-black mb-2 mt-7">Career & Jobs</h2>

        <p className="mb-4">
          Day by day, the scope of Ayurvedic is overlapping to the other medical
          system not only in India but also in the world. In many cases, people
          have taken the experience for the trustfulness of the Ayurvedic system
          and medicines treating chronic and non-healable diseases. In many
          cases, when the allopathic system becomes a failure with a particular
          disease and surrenders, the Ayurvedic medicine does the magical effect
          to rejuvenate the illness or the patient. Some of the job profiles are
          –
        </p>
