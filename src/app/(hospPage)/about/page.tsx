...
<p class="text-3xl font-extrabold dark:text-white">  Sustainable, Scalable and Replicability of Operations</p>
          <p className=" mt-3">
...
<p class="text-3xl font-extrabold dark:text-white"> Affordability and Accessibility </p>
          <p className=" mt-3">
