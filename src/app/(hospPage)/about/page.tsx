...
<h3 className=" text-[30px] font-semibold">  Sustainable, Scalable and Replicability of Operations</h3>
          <p className="mt-3">
...
<div className=" text-[30px] font-semibold"> Affordability and Accessibility </div>
          <p className="mt-3">
