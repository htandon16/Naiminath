...
<h3 className="text-2xl font-bold dark:text-white">  Sustainable, Scalable and Replicability of Operations</h3>
          <p className=" mt-3">
...
<h3 className="text-2xl font-bold dark:text-white"> Affordability and Accessibility </h3>
          <p className=" mt-3">
