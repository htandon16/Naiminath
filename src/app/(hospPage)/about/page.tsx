...
<h3 class="b-4 text-2xl font-extrabold leading-none tracking-tight text-gray-900 md:text-2xl lg:text-6xl dark:text-white">  Sustainable, Scalable and Replicability of Operations</h3>
          <p className=" mt-3">
...
<h3 class="b-4 text-2xl font-extrabold leading-none tracking-tight text-gray-900 md:text-2xl lg:text-3xl dark:text-white"> Affordability and Accessibility </h3>
          <p className=" mt-3">
