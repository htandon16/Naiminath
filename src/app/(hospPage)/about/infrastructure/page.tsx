...
const Page = () => {
  const imageUrls = [
    `/images/gallery/gallery1-min.jpg`,
    `/images/gallery/gallery2-min.jpg`,
    `/images/gallery/gallery3-min.jpg`,
    `/images/gallery/gallery14-min.png`,
    `/images/gallery/gallery15-min.png`,
    `/images/gallery/gallerya.JPG`,
    `/images/gallery/galleryb.JPG`,
    `/images/gallery/galleryc.JPG`,
    `/images/gallery/galleryd.JPG`,
    `/images/gallery/gallerye.JPG`,
