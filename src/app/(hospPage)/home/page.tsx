  ...
  return (
    ...
    <AyurvedaTreatmentSection />
        ...
        <div className="flex flex-row flex-4 gap-2  justify-center">
          ...
          <Image className="rounded-md w-auto aspect-auto h-auto" src="/images/gallery/n1.jpg" alt="Patient 1"/>
          <Image className="rounded-md w-auto aspect-auto h-auto" src="/images/gallery/n2.jpg" alt="Patient 2"/>
