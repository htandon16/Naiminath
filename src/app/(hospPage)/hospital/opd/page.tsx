 ...
 const router = useRouter();
  ...
  return (
    <>
      ...
      {/* Main Content */}
      <div className="hidden md:flex lg:flex xl:flex flex-col items-center justify-center font-sans h-full w-full">
        <div
          className="bg-[url('/images/aboutus_bg.jpg')] bg-cover h-[20vh] w-full flex items-center justify-center text-[#54595f] md:text-[32px] text-[28px] text-center font-extrabold border-b-[0.009px] border-[#8b939465]"
        >
          {itemsContent.title}
        </div>
        <div
          className="flex md:flex-row flex-col w-full justify-center items-start md:pt-12 pb-16 bg-[')] bg-no-repeat bg-cover bg-center"
          style={{
      ...
      <div className="md:hidden lg:hidden xl:hidden flex flex-col items-center justify-center font-sans h-full w-full">
        <div
          className="bg-[url('/images/aboutus_bg.jpg')] bg-cover h-[20vh] w-full flex items-center justify-center text-[#54595f] md:text-[32px] text-[28px] text-center font-extrabold border-b-[0.009px] border-[#8b939465]"
        >
          {itemsContent.title}
        ...
        >
          <div className="flex flex-col lg:basis-[30%] lg:flex-none gap-3 items-center justify-center">
