  ...
  return (
    <>
      ...
      <div className="flex flex-col items-center justify-center font-sans h-full w-full">
        ...
        <div className="flex md:flex-row flex-col w-full justify-center items-start md:pt-12 pb-16 bg-[')] bg-no-repeat bg-cover bg-center relative">
          <div className="hidden md:flex flex-col lg:basis-[30%] lg:flex-none gap-3 items-center justify-center absolute bottom-0 mb-16">
