...
export async function POST(req: NextRequest) {
  ...
  const destinationDirPath = path.join(process.cwd(), process.env.LIVE_DOC_STORE_PATH!);
...
export async function GET(request:NextRequest) {
    ...
    const directoryPath = path.join(process.cwd(), process.env.LIVE_DOC_STORE_PATH!);
